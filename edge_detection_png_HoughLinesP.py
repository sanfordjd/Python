...
#print(hlines)	
#cv2.imwrite('HoughLines_0.png', img)
#cv2.line(img, (348,159), (348,159), (0,0,255), 5)	
cv2.line(img, (310,0), (310,719), (0,0,255), 2)	
#cv2.line(img, (493, 396), (493, 396), (0,0,255), 2)
#cv2.line(img, (0, 0), (0, 0), (0,0,255), 1)
#cv2.line(img, (0, 396), (719, 396), (0,0,255), 2)
cv2.line(img, (420,0), (420,719), (0,0,255), 2)  #mid line of stream
#cv2.line(img, (719, 539), (719, 539), (0,0,255), 1)	#bottom right corner of image
	
#cv2.line(img, (500,456), (500,456), (0,0,255), 2)
cv2.line(img, (510,0), (510,719), (0,0,255), 2)
 
#***********************************************************************
# What I really need is to find the largest y-value/ smallest y-value
# and then and then get the corresponding x-components of those values
...
#cv2.line(img, (high_right[0],high_right[1]),(high_right[0],high_right[1]), (0,0,255), 3)
#cv2.line(img, (high_left[0],high_left[1]),(high_left[0],high_left[1]), (255,0,255), 3)
#cv2.line(img, (low_right[0],low_right[1]),(low_right[0],low_right[1]), (0,255,255), 3)
#cv2.line(img, (low_left[0],low_left[1]),(low_left[0],low_left[1]), (255,0,0), 3)

high_right[0] = 450 #for debugging
