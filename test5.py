...
while(True):
	...
	#ie, a point will look like [348, 159, 348, 159]
		...
		if len(hlines.shape) == 3 :
			...
			#we will assume that this camera was a 15FPS camera when doing the 
			...
			#cv2.line(frame, (0,90),(700,90), (255,0,0),3) #upper y-bound
			#cv2.line(frame, (0,400),(700,400), (255,0,0),3) #bottom y-bound
