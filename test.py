...
while(T != False):
	...
	a,b,c = hlines.shape
	#for k in range(a):
	#	cv2.line(cap, (hlines[k][0][0], hlines[k][0][1]), (hlines[k][0][2], hlines[k][0][3]), (0,255,0), 3, cv2.LINE_AA)
			##lines: a vector that stores the parameters (x_start, y_start, x_end, y_end) of the detected lines
