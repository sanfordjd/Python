...
while(True):
	...
	#Find the highest and lowest points on the stream
	#This needs to be fixed so that the "noise" not near the stream is 
	#filtered out ... 
	if len(hlines.shape) == 3 :
		...
		#cv2.line(frame, (320,0),(320,700), (255,0,0),3) #lower x-bound
		#cv2.line(frame, (505,0),(505,700), (255,0,0),3) #upper x-bound
